...
nnoremap <Leader>iof :vnew output.txt <bar> new input.txt <CR>

nnoremap <Leader>cpf i#include <bits/stdc++.h><Esc>o#define ll long long<Esc>ousing namespace std;<Esc>ovoid solve() {<Esc>oint n;<Esc>ocin >> n;<Esc>ocout << n;<Esc>o}<Esc>o<CR>int main() {<Esc>oios::sync_with_stdio(false);<Esc>ocin.tie(nullptr);<Esc>oint t;<Esc>ocin >> t;<Esc>owhile (t--) {<Esc>osolve();<Esc>o}<Esc>oreturn 0;<Esc>o}

nnoremap <Leader>cpif i#include <bits/stdc++.h><Esc>ousing namespace std;<Esc>o#define ll long long<Esc>ovoid indef(){<Esc>o#ifndef ONLINE_JUDGE<Esc>ofreopen("input.txt","r",stdin);<Esc>ofreopen("output.txt","w",stdout);<Esc>o#endif<Esc>o}<Esc>o<Esc>ovoid solve() {<Esc>oint n;<Esc>ocin >> n;<Esc>ocout << n;<Esc>o<Esc>o}<Esc>o <Esc>oint main() {<Esc>oios::sync_with_stdio(false);<Esc>ocin.tie(nullptr);<Esc>o<Esc>oindef();<Esc>o<Esc>oint t;<Esc>ocin >> t;<Esc>o<Esc>owhile (t--) {<Esc>osolve();<Esc>o}<Esc>o<Esc>oreturn 0;<Esc>o}<Esc>:vnew output.txt <bar> new input.txt <CR>
